...
<Wrapper className='flex justify-between max-sm-tab:flex-col-reverse'>
<Wrapper className='flex-1 flex flex-col items-center justify-center max-xs-tab:py-8 max-md-mb:hidden'>
...
<Heading1 className='text-center px-[93px] max-tab:p-5 max-md-mb:text-3xl'>
The way to get started is to quit talking and begin doing.
</Heading1>
  </Wrapper>
  <Wrapper className='flex-1 login-bg relative min-h-[100vh]   max-md-mb:items-center max-md-mb:flex '>
    <Wrapper className='relative z-[1] flex flex-col items-center p-[60px] max-xs-tab:px-6 max-tab:p-5 max-xs-tab:py-10'>
    <Image src={Logo.src} alt={'Logo'} width={Logo.width} height={Logo.height} className='max-xs-tab:max-w-[100px]'/>
      <H1 tag={true} className='text-white max-w-[450px] text-center mt-[176px] mb-[15px] max-xs-tab:mt-8 max-xs-tab:text-3xl'>
