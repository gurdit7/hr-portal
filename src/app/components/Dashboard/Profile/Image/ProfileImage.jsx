...
const ProfileImage = ({size}) => {
  ...
  <Wrapper className='flex items-center justify-center'>
        {image === '' && (<svg width={size} height={size} viewBox="0 0 512 512" fill="none" className="block  transition-all duration-200" >
...
{image !== '' && (<Image src={image} alt="Profile Image" width={size} height='61px' className="h-auto transition-all duration-200" />) }
