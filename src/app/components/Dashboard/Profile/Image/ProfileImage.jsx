...
{_image !== '' && (
<Wrapper className={`border border-dark rounded-full p-[5px] w-full`}>
  <Wrapper className='relative pb-[100%] w-full'>
<Image src={_image || Placeholder.src} alt="Profile Image" width={size} height={size} className="h-full absolute top-0 left-0 w-full object-cover transition-all duration-200 border dark:border-gray-600 border-light-500 rounded-full" />
</Wrapper>
</Wrapper>
) }
