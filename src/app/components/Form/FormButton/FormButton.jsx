...
const FormButton = ({ children, type, btnType, label, loading, loadingText, event, additionalCss}) => {
    ...
    btnType === 'solid' ? classes += ' bg-accent w-full  rounded-lg text-base font-poppins font-medium py-[15px] text-white hover:bg-dark-blue' : '';
    btnType === 'outlined' ? classes += ' hover:bg-accent hover:text-white border border-accent w-full text-accent px-12  rounded-lg text-base font-poppins font-medium py-[10px]' : '';
